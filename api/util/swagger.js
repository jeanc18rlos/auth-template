...
let appSdkDir = path.join(__dirname,'..','..','app','src','services','areuin-sdk');
...
function createSdk() {
  ...
  return new Promise((resolve, reject) => {
    ...
    let cmd = spawn('swagger-codegen', ['generate', '-i', swaggerDir + '/AreuinAPI-exported.yml', '-l', 'typescript-angular2', '-o', apiSdkDir]);
