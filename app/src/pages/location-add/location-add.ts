...
import { CustomAuthorizerClient, IamAuthorizerClient } from "../../services/areuin-api.service";
...
export class LocationAddPage {
  ...
  public formData = {
    name: "",
    description: "",
    imageUrl: "https://s3.amazonaws.com/areuin-public-image-repository/building.png"
  };
